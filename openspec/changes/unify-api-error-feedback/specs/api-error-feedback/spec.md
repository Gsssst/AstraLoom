...
The frontend SHALL translate API, timeout, network, validation, authentication, and permission failures into concise Chinese user-facing messages instead of generic "失败" text or silent no-ops.
