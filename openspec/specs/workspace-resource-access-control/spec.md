...
## Purpose
Define workspace-derived resource access so members can read or edit explicitly linked research and writing resources according to their project-space role while preserving owner-only deletion.
## Requirements
