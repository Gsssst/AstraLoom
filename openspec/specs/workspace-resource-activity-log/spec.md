...
## Purpose
Define durable project-space resource binding and activity visibility so workspace collaboration can be audited, summarized, and governed beyond legacy metadata-only links.
## Requirements
