...
## Purpose
Define resource-page workspace backlinks so papers, research projects, and writing drafts can show and manage their project-space associations without requiring users to start from the workspace page.
## Requirements
