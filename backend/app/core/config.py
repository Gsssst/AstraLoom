...
class Settings(BaseSettings):
    ...
    PDF_VISUAL_EVIDENCE_ENABLED: bool = True
    PDF_VISUAL_EVIDENCE_ASSET_DIR: str = "./uploads/visual-evidence"
    PDF_VISUAL_EVIDENCE_MAX_PAGES: int = 20
    PDF_VISUAL_EVIDENCE_MAX_ASSETS: int = 40
