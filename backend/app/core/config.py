...
class Settings(BaseSettings):
    ...
    PDF_TABLE_PARSER_COMMAND: str = ""
    PDF_TABLE_PARSER_TIMEOUT_SECONDS: float = 180.0
    PDF_TABLE_PARSER_MAX_OUTPUT_BYTES: int = 10_000_000
    PDF_VISUAL_ASSET_ENABLED: bool = True
    PDF_VISUAL_ASSET_MAX_PAGES: int = 12
    PDF_VISUAL_ASSET_MAX_ASSETS: int = 40
    PDF_VISUAL_ASSET_RENDER_SCALE: float = 1.25
    PDF_VISUAL_ASSET_IMAGE_FORMAT: str = "png"
    PDF_VISUAL_SUMMARY_ENABLED: bool = False
    PDF_VISUAL_SUMMARY_MAX_ASSETS: int = 8
